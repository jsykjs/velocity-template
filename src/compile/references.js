  ...
  Object.assign(Velocity.prototype, {
    ...
    getReferences: function(ast, isVal) {
      ...
      if (ast.path) {
        ...
        ast.path.some(function(property, i, len) {
    ...
    getLocal: function(ast) {
      ...
      var isLocaled = this.conditions.some(function(contextId) {
    ...
    getPropMethod: function(property, baseRef, ast) {
      ...
      // setter 处理
        ...
        return Object.keys(baseRef);

      } else if (id === 'entrySet' && !baseRef[id]) {

        ret = [];
        baseRef.forEach(function(value, key) {
        ...
        property.args.forEach(function(exp) {
